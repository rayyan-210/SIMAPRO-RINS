    ...
    <div class="flex justify-center items-center min-h-screen">
        <div class="bg-white shadow-xl border border-black rounded-lg p-16 ">
            ...
            <div class="flex flex-col md:flex-row items-start gap-4">
                ...
                <button>
                <i class="bx bx-plus text-3xl text-black hover:text-amber-300"onclick="inputgambar()"></i>
                ...
                <div class="flex-1 space-y-4">
                    ...
                    <button class="flex mx-auto bg-blue-500 text-white font-bold px-4 py-2 rounded-xl hover:bg-blue-600"onclick="showadd(true)">Submit</button>
                </div>
            </div>
        </div>
    </div>
